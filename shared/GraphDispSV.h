#if !defined(AFX_GRAPHDISPSV_H__957125D4_AE1D_11D3_9C31_0060970CEBA8__INCLUDED_)
#define AFX_GRAPHDISPSV_H__957125D4_AE1D_11D3_9C31_0060970CEBA8__INCLUDED_
...
#ifndef _DEBUG
inline float CGraph3dDataSV::RangeZmm(float z)
{
   float f = (Zmax-Zmin);
   if ( f == 0 ) return 0;
   return (z-Zmin)/f;
...
struct NMGRCLICKSV : public tagNMMOUSE {
    CSize   sz;
};
typedef  NMGRCLICKSV NMGRMOUSESV;

                            
class CGraphDispSV : public CWnd, public CGraph3dDataSV
{
// Construction
public:
   CGraphDispSV();
...
public:
   ...
   void CreatePalette(int nPal,int nument=32, TGDPaletteSV *srcP = NULL);
   virtual ~CGraphDispSV();
...
#endif // !defined(AFX_GRAPHDISPSV_H__957125D4_AE1D_11D3_9C31_0060970CEBA8__INCLUDED_)
