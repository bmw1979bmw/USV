// FormularPN.cpp : implementation file
//

#include "stdafx.h"
#include "FormularPN.h"
#include "MainFrm.h"
#include "MainDoc.h"
...
CFormularPN::CFormularPN(TFormularPN *psrc,CWnd* pParent /*=NULL*/)
: CDialog(CFormularPN::IDD, pParent)
{
   //{{AFX_DATA_INIT(CFormularPN)
   //}}AFX_DATA_INIT
   p = *psrc;
   p1= psrc;
   mnR = 0;
...
void CFormularPN::DoDataExchange(CDataExchange* pDX)
{
...
//    DDX_Text(pDX, IDC_H_GF, p.H_GF);
   ...
   //{{AFX_DATA_MAP(CFormularPN)
   // NOTE: the ClassWizard will add DDX and DDV calls here
   //}}AFX_DATA_MAP
}


BEGIN_MESSAGE_MAP(CFormularPN, CDialog)
//{{AFX_MSG_MAP(CFormularPN)
...
/////////////////////////////////////////////////////////////////////////////
// CFormularPN message handlers

void CFormularPN::OnSaveForm() 
{
...
void CFormularPN::OnOK() 
{
   // TODO: Add extra validation here
   if (!UpdateData(TRUE)) return;
   
   memcpy(p1,&p,sizeof(TFormularPN));
