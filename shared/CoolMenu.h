...
//
class CCoolMenuManager : public CSubclassWnd {
public:
	...
	BOOL LoadToolbar(UINT nID, COLORREF clrTransparent=RGB(192,192,192));						// load one toolbar
...
//
struct CCoolMenuItemInfo : public MENUITEMINFO {
	CCoolMenuItemInfo()
	{ memset(this, 0, sizeof(MENUITEMINFO));
#if ( _WIN32_WINNT >= 0x0500 ) 
	  cbSize =  int((BYTE*)&hbmpItem - (BYTE*)&cbSize); // for work under NT4
#else
